...
def build_rag_graph():
    """
    Build and return a compiled advanced RAG graph combining BM25 and naive retrieval for product information retrieval.
    ...
    bm25_retriever = BM25Retriever.from_documents(docs, embedding=embedding_model)

    # Create ensemble retriever
    retriever_list = [bm25_retriever, retriever]
